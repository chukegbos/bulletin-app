      ...
      <div class="modal-dialog" style="background:white">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>NB: The default password is <b><span style="color:green">secret</span></b></p>
              <form method="post" class="profile-wrapper" action="{{ url('admin/addagent') }}" >
                 {{ csrf_field() }}
                  ...
                  <div class="form-group">
                      ...
                      <select name="role" required="" class="form-control">
                        ...
                        <option value="State Admin">Admin</option>  
